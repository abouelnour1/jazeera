        ...
        <div className={`w-full md:flex-1 p-4 md:p-8 md:overflow-y-auto bg-white/50 print:bg-white print:p-0 print:overflow-visible ${!selectedCondition ? 'hidden md:block' : 'block print:block'}`}>
            {!advice ? (
                ...
                <div className="animate-fade-in-up space-y-6 max-w-4xl mx-auto pb-32 print:pb-0 print:space-y-2 print-content-wrapper">
                    ...
                    <div className="print-only hidden w-full mb-1 border-b border-gray-200 pb-1 flex flex-col items-center justify-center">
                    ...
                    {/* Content Header */}
                    <div className="mb-8 print:mb-2 text-center print:text-center">
                         <div className="inline-block border-b-4 border-brand-500/50 pb-1 print:border-b print:pb-0">
                            <h3 className="text-3xl print:text-lg font-extrabold text-slate-800 print:text-black">
                                {advice.condition}
                            </h3>
                         </div>
                    </div>
                    ...
                    <div className="space-y-8 print:space-y-1">
                        ...
                        <div className="grid md:grid-cols-2 print:grid-cols-2 gap-6 print:gap-2 direction-rtl">
                            ...
                            <div className="bg-white p-6 md:p-8 rounded-3xl border border-green-100 shadow-[0_4px_20px_rgba(34,197,94,0.05)] relative overflow-hidden print:shadow-none print:border print:border-gray-400 print:rounded-md print:p-2 print:bg-transparent box-container">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-green-50 rounded-bl-full -mr-8 -mt-8 -z-10 no-print"></div>
                                
                                <h4 className="font-bold text-green-700 flex items-center gap-2 mb-6 text-xl print:text-xs print:text-black print:mb-1 print:border-b print:border-gray-200 print:pb-0.5">
                                    <div className="p-2 bg-green-100 rounded-lg no-print">
                                        <CheckCircle2 className="w-6 h-6 text-green-600" />
                                    </div>
                                    <span className="print-only text-green-600 font-bold ml-1 text-sm">✓</span>
                                ...
                                <ul className="space-y-3 print:space-y-0.5">
                                    {advice.allowedFoods.map((item, idx) => (
                                        <li key={idx} className="flex items-start gap-3 text-sm print:text-[9px] print:leading-tight font-medium text-slate-700 print:text-black">
                            ...
                            <div className="bg-white p-6 md:p-8 rounded-3xl border border-red-100 shadow-[0_4px_20px_rgba(239,68,68,0.05)] relative overflow-hidden print:shadow-none print:border print:border-gray-400 print:rounded-md print:p-2 print:bg-transparent box-container">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-red-50 rounded-bl-full -mr-8 -mt-8 -z-10 no-print"></div>

                                <h4 className="font-bold text-red-700 flex items-center gap-2 mb-6 text-xl print:text-xs print:text-black print:mb-1 print:border-b print:border-gray-200 print:pb-0.5">
                                    <div className="p-2 bg-red-100 rounded-lg no-print">
                                        <XCircle className="w-6 h-6 text-red-600" />
                                    </div>
                                    <span className="print-only text-red-600 font-bold ml-1 text-sm">X</span>
                        ...
                        {/* Tips */}
                        <div className="bg-blue-50/50 p-6 md:p-8 rounded-3xl border border-blue-100 print:bg-transparent print:border print:border-gray-400 print:rounded-md print:p-2 box-container">
                            <h4 className="font-bold text-blue-800 mb-6 flex items-center gap-2 text-lg print:text-xs print:text-black print:mb-1 print:border-b print:border-gray-200 print:pb-0.5">
                                <div className="p-2 bg-blue-100 rounded-lg no-print">
                                    <Utensils className="w-5 h-5 text-blue-600" />
                                </div>
                                <span className="print-only font-bold ml-1 text-sm">!</span>
                                <span className="print:font-extrabold">نصائح عامة (General Tips)</span>
                            </h4>
                            <ul className="grid print:grid-cols-3 gap-3 print:gap-x-4 print:gap-y-0.5">
                                 {advice.tips.map((tip, idx) => (
                                    <li key={idx} className="flex items-start gap-3 text-sm print:text-[9px] print:leading-tight text-slate-700 bg-white p-4 rounded-xl shadow-sm border border-blue-100/50 print:bg-transparent print:shadow-none print:border-0 print:p-0 print:text-black">
                    ...
                    <div className="bg-amber-50 text-amber-800 p-4 rounded-xl text-xs flex items-start gap-3 mt-8 border border-amber-100 leading-relaxed print:bg-transparent print:border-t print:border-b-0 print:border-l-0 print:border-r-0 print:border-gray-300 print:text-black print:text-[8px] print:mt-2 print:pt-1 print:rounded-none">
                    ...
                    <div className="hidden print:block mt-1 text-center border-t border-gray-100 pt-1">
                        <p className="text-[7px] text-gray-400">تاريخ الطباعة: {new Date().toLocaleDateString('ar-SA')}</p>
                    </div>
                </div>
            )}
        </div>
